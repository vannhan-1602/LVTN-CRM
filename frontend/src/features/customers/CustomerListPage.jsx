  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <StatCard
          label="Tổng khách hàng (trang này)"
          value={stats.total}
          icon={Users}
        />
        <StatCard
                ...
                <tr>
                  <td colSpan={7}>
                    <EmptyState
                      ...
                      description={
                        !loading
                          ? "Thêm khách hàng mới để bắt đầu quản lý quan hệ."
                          : undefined
                      }
                    />
                  </td>
                      ...
                      {item.loaiKhachHangId ? (
                        <Badge
                          label={
                            ...
                            getTenLoaiKH(item.loaiKhachHangId)
                          }
                          colorClass="bg-info-50 text-info-700"
                        />
                      ) : (
                        "—"
                      )}
                    ...
                    <td className="px-5 py-3.5">
                      {item.tinhTrangId ? (
                        <Badge
                          label={
                            item.tenTinhTrang ??
                            getTenTinhTrang(item.tinhTrangId)
                          }
